...
- 남은 수업의 난이도를 정하는 기초 진단 20문항 응답

## 파일 받는 곳

수업 중 필요한 파일은 현재 장표 아래의 **첨부파일**에서 받습니다.

- 40번: 팀 시작 파일과 이 학생 안내서
- 58번: 프로젝트 예시 주제 안내
- 73번: AWS 로그인·S3 실습 안내
- 87번: `sample-bike.csv`
...
7. 87번 장표에서 `sample-bike.csv`를 받고 버킷에 올립니다.
...
9. 마지막 진단 장표의 20문항에 답합니다. 모르는 문항은 추측하지 말고 `모르겠다`를 선택합니다. 진단 정답 수는 성적에 반영하지 않습니다.
