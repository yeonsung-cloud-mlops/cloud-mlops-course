...
2. 서로 다른 역할을 원하는 학생 네 명과 30초씩 이야기합니다.
3. 3~4명으로 팀을 만듭니다.
4. `TEAM_CHARTER.md`에 연락·회의·마감·갈등 처리 규칙을 적습니다.
5. `ROLE_ROTATION.csv`에 1~4주 역할을 정합니다.
6. `TEAM_REGISTRATION.md`에 팀을 등록합니다.

## 3교시

예시 주제 8개를 살펴보고, 각자 후보 세 개를 고릅니다. 팀에서 채점한 뒤 1순위와 2순위를 남깁니다. 3주차에 실제 데이터를 열어 본 뒤 최종 결정합니다.
...
7. 59번 장표에서 `sample-bike.csv`를 받고 버킷에 올립니다.
